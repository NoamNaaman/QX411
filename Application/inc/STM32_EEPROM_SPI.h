...
#define EEPROM_PAGESIZE        512    /*!< Pagesize according to documentation */
#define EEPROM_BUFFER_SIZE     512    /*!< EEPROM Buffer size. Setup to your needs */

#define EEPROM_CS_HIGH()    output_high(EECS2) // HAL_GPIO_WritePin(EEPROM_CS_GPIO_Port, EEPROM_CS_Pin, GPIO_PIN_SET)
#define EEPROM_CS_LOW()    output_low(EECS2) // HAL_GPIO_WritePin(EEPROM_CS_GPIO_Port, EEPROM_CS_Pin, GPIO_PIN_RESET)
...
EepromOperations EEPROM_WritePage(uint8_t* pBuffer,  u32 WriteAddr, u32 NumByteToWrite);
